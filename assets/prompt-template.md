...
- {{multitenant_line}}: אם המערכת multi-tenant (או בעלים יחיד שהמידע שלו פרטי) - מלא במשפט "כל משתמש רואה רק את המידע שלו."; אם המידע משותף לכל המשתמשים - השאר ריק (מחק את השורה).
